...
pub enum ButtonVariant {
    ...
    Destructive,
    /// FlowCatalyst: PrimeVue's `text` button, in the primary colour
    /// (section actions such as Edit, Manage Roles).
    Text,
    /// FlowCatalyst: PrimeVue's outlined `danger` button (Delete, Deactivate).
    DestructiveOutline,
    /// FlowCatalyst: PrimeVue's outlined `success` button (Activate).
    SuccessOutline,
}
...
impl ButtonVariant {
    ...
    fn classes(self) -> StaticClass {
        match self {
            ...
            Self::Text => {
                class!("border-transparent text-primary hover:bg-primary/10 active:bg-primary/15",)
            }
            ...
            Self::SuccessOutline => {
                class!("border-success text-success hover:bg-success/5 active:bg-success/10",)
            }
        }
    }
}
