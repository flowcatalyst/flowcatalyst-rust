//! `Digest` and `SignerIdentity`, the two value types the verifier shares with
//! the platform and the host (Java `platform/function/Digest.java`, `SignerIdentity.java`).
