...
2. An explicit manifest runtime value such as `component`, instead of the host sniffing the artifact plus the
   `wasi_http_incoming_handler` alias. This needs Java's schema and DB CHECK to change.
