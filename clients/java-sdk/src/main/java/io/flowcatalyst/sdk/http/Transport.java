...
public final class Transport {
     ...
     * separate process that verifies the same platform bearer token (owner
     * ruling 2 of 2026-09-25). Same one-shot refresh on 401 as the platform
     * calls.
     */
    ...
    /**
     * Unauthenticated request against an absolute URL. The router resource no
     * longer uses it (see {@link #rawAuthenticated}); kept for callers.
     */
